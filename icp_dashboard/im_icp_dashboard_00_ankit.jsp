...
<script>
		function compare_report()
		{
				...
				document.entryfrm.action="im_icp_dashboard_00_ankit.jsp?&icp="+document.entryfrm.compare_icp.value;
...
/************************************** Start : Flight Count Statistics *******************************************/
	...
	%>
			<!--			<table  style="padding:1px 1px;border-collapse: collapse;background-color:#FFFFFF;font-family:verdana;font-size:10pt;text-align:right;" align="center" bordercolorlight="#FF99CC" bordercolordark="#FF99CC" bordercolor="#FF99CC" border="1"  cellpadding="0" cellspacing="0" width="60%"> 
							<tr style="background-color:#E6E6EA;font-weight:bold">
								<td style="text-align:center;">S.No.&nbsp;</td>
								<td style="text-align:center;">Boarding&nbsp;Date</td>
								<td style="text-align:center;">Hours</td>
								<td style="text-align:left;">Flight&nbsp;Number</td>				
								<td style="text-align:right;">Pax&nbsp;Count</td>				
							</tr> -->
			<%
			...
			{
				//out.println(keyValue + "&nbsp;===&nbsp;" + borDateHoursFlightnameCountPair.get(keyValue) + " oooooooooo " + borDateHoursFlightnameCountPair.get(keyValue).split("####").length + "<BR>");
				...
				out.println(maxFlightInHour);
				serial_no++;

				%>
						<!--	<tr>
										<td style="text-align:center;"><%=serial_no%></td>
										<td style="text-align:center;"><%=keyValue.split("#####")[0]%></td>
										<td style="text-align:center;"><%=keyValue.split("#####")[1]%></td>
										<td style="text-align:left;">
											<table  style="padding:1px 1px;border-collapse: collapse;background-color:#FFFFFF;font-family:verdana;font-size:10pt;text-align:left;" align="center" bordercolorlight="#FF99CC" bordercolordark="#FF99CC" bordercolor="#FF99CC" border=1;  width="100%" cellpadding="0" cellspacing="0">
												<%
													for(int i = 0 ;i<borDateHoursFlightnameCountPair.get(keyValue).split("####").length;i++)
													{
														//out.println(borDateHoursFlightnameCountPair.get(keyValue).split("$$")[i] + "&nbsp;");
														%><tr><td><%=borDateHoursFlightnameCountPair.get(keyValue).split("####")[i].split("##")[0]%></td></tr><%
													}
												%>
											</table>
										</td>
										<td style="text-align:right;">
											<table  style="padding:1px 1px;border-collapse: collapse;background-color:#FFFFFF;font-family:verdana;font-size:10pt;text-align:right;" align="center" bordercolorlight="#FF99CC" bordercolordark="#FF99CC" bordercolor="#FF99CC" border=1;  width="100%" cellpadding="0" cellspacing="0">
												<%
													for(int i = 0 ;i<borDateHoursFlightnameCountPair.get(keyValue).split("####").length;i++)
													{
														%><tr><td><%=(borDateHoursFlightnameCountPair.get(keyValue).split("####")[i]).split("##")[1]%></td></tr><%
													}
												%>
											</table>
										</td>
	...
	/////////////////////////////////////////////////////////// Strat : New Table for Flight Count ////////////////////////////////////////////////////////////////////////////////////
			...
			%>			
						<BR><BR>
						<table  style="padding:1px 1px;border-collapse: collapse;background-color:#FFFFFF;font-family:verdana;font-size:10pt;text-align:right;" align="center" bordercolorlight="#FF99CC" bordercolordark="#FF99CC" bordercolor="#FF99CC" border="0"  cellpadding="0" cellspacing="0" width="100%"> 
			...
			for(String keyValue:borDateHoursFlightnameCountPair.keySet())
			{
				...
				//out.println( keyValue.split("#####")[1] + " : " + maxFlightInHour + " - " + currentFlightInHour + " = " + differenceInFlightInHour + "<BR>");
										...
										<td style="vertical-align:bottom">
											<table  style="padding:1px 1px;border-collapse: collapse;background-color:#FFFFFF;font-family:verdana;font-size:10pt;" align="center" bordercolorlight="#FF99CC" bordercolordark="#FF99CC" bordercolor="#FF99CC" border=0;  width="100%" cellpadding="0" cellspacing="0">
												...
												%>
													...
													<table  style="padding:1px 1px;border-collapse: collapse;font-family:verdana;font-size:10pt;" align="center" bordercolorlight="#FF99CC" bordercolordark="#FF99CC" bordercolor="#FF99CC" border=2;  width="100%" cellpadding="0" cellspacing="0">
												...
												<%
													for(int i = 0 ;i<borDateHoursFlightnameCountPair.get(keyValue).split("####").length;i++)
													{
														...
														{%>
															<tr>
																<td style="background-color:#fb666e;font-weight: bold;" >&nbsp;<%=borDateHoursFlightnameCountPair.get(keyValue).split("####")[i].split("##")[0].replace("-","&#8209;")%>&nbsp;</td>
														...
														{%>
															<tr>
																<td style="background-color:#38acff;border-color: #00539a;width:25%; font-weight: bold;" >&nbsp;<%=borDateHoursFlightnameCountPair.get(keyValue).split("####")[i].split("##")[0].replace("-","&#8209;")%>&nbsp;</td>
