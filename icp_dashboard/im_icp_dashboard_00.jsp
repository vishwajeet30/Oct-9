	...
	<div class="col-sm-2">
		...
		<% 
			...
			<tr style="font-size: 11px; font-family: 'Arial', serif; text-align: center; border-color: #6929c4;height:18px;">
				<td style="background-color:#be95ff;border-color: #6929c4;width:33.33%; font-weight: bold;"><%=weekListPAX[i]%></td>
...
<div class="col-sm-2">
		...
		%>
			<tr style="font-size: 11px; font-family: 'Arial', serif; text-align: center;height:18px;border-color: #ed3e12">
				<td style="background-color:#f4896f;border-color: #ed3e12;width:33.33%; font-weight: bold;"><%=weekListFlights[i]%></td>
